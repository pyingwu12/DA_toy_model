...
main_PF: Particle Filter for Lorenz 96 model

resampling: resampling used in main_PF

stepit: integration

rmse96: calculate root mean (of different variables) squre error of ensemble mean
